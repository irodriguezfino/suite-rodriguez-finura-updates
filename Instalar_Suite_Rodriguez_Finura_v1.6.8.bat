...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.8_full.zip"
set "EXPECTED_SHA=EA36BCF9B88560255E88E0A07E827B085AC1646025FC7B7F7F87FF806CCC4DD4"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.8_full.zip"

echo Instalando %APP_NAME% 1.6.8
