...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.5.6_full.zip"
set "EXPECTED_SHA=9F8F55CB83D65A753388AA9ADC94A0977CD2AFBEA580A650DC1B4AABBD5C7CA2"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.5.6_full.zip"

echo Instalando %APP_NAME% 1.5.6
