...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.2_full.zip"
set "EXPECTED_SHA=298C92ECB04813D1438D17AB694C0234E82C9430FC01F9B3B16A013DF12FEB89"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.2_full.zip"

echo Instalando %APP_NAME% 1.7.2
