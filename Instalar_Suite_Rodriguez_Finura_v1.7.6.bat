...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.6_full.zip"
set "EXPECTED_SHA=2C4962CAD120F93C20FA9DD86F6D2CFE83E0D45956084EE340749BB744BAD122"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.6_full.zip"

echo Instalando %APP_NAME% 1.7.6
