...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.22_full.zip"
set "EXPECTED_SHA=D9CD7C7A06B012CBB2C5643D518739E56858CC19EF0C5155449B6FF17762AB9B"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.22_full.zip"

echo Instalando %APP_NAME% 1.7.22
