...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.16_full.zip"
set "EXPECTED_SHA=D438FE2A5752631A6C9E98086C30104F203B3B7304B545CCDA209A19786B0851"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.16_full.zip"

echo Instalando %APP_NAME% 1.7.16
