...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.1_full.zip"
set "EXPECTED_SHA=E4C020563C748F39E9F691522ADEDF61BAAADE98E92A3CDE16FC617CA7E7EB5C"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.1_full.zip"

echo Instalando %APP_NAME% 1.6.1
