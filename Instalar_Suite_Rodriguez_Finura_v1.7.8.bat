...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.8_full.zip"
set "EXPECTED_SHA=2CD41D90E995EEAC200EC2D38C0B832A2013F516CC2C6D219B1EA5CF4BCA5712"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.8_full.zip"

echo Instalando %APP_NAME% 1.7.8
