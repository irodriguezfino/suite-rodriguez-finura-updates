...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.10_full.zip"
set "EXPECTED_SHA=B31E3BDCB55B6B8091AFF8FC0E38007952CEB5064DFDAC2B40E0528FE23A858A"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.10_full.zip"

echo Instalando %APP_NAME% 1.7.10
