...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.2_full.zip"
set "EXPECTED_SHA=8817CA52A1356976257DA4AA1951C988644D93F139789E0BFC47ACFFC2DA9CFE"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.2_full.zip"

echo Instalando %APP_NAME% 1.6.2
