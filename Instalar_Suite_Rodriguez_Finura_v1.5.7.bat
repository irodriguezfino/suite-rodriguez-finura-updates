...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.5.7_full.zip"
set "EXPECTED_SHA=A716E9F01D67BFCB499BA2A3E01E433F8DD11D163B2C170C97781B9FAD83D949"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.5.7_full.zip"

echo Instalando %APP_NAME% 1.5.7
