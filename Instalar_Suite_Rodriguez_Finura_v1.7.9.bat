...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.9_full.zip"
set "EXPECTED_SHA=71A841028197A2DAECA9A0418A435870267C5E8A5970383E52327A312F5D156A"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.9_full.zip"

echo Instalando %APP_NAME% 1.7.9
