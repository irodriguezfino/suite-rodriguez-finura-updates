...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.7_full.zip"
set "EXPECTED_SHA=C7CA683F2AD373F0DC96B7A4D279F8FDC2B86B0B8E4C213EF8ED9F91A4F6A8FB"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.7_full.zip"

echo Instalando %APP_NAME% 1.6.7
