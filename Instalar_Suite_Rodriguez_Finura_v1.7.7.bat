...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.7_full.zip"
set "EXPECTED_SHA=6B578DDB4A9D058488FEB48E9398089DB0DC972375B90FF49C91432C33A556E6"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.7_full.zip"

echo Instalando %APP_NAME% 1.7.7
