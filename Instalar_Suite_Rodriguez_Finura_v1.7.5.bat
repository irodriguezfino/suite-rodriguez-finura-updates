...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.5_full.zip"
set "EXPECTED_SHA=CC706A90CC3168EAD9402718EC5A3D5B13F0511091E04DC4B868462AB550F506"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.5_full.zip"

echo Instalando %APP_NAME% 1.7.5
