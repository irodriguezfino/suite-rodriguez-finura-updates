...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.3_full.zip"
set "EXPECTED_SHA=0587A2B7380CAB9BEBF9F34844A633CBDEFDE978CCF8F8DD99220D7623D28491"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.3_full.zip"

echo Instalando %APP_NAME% 1.7.3
