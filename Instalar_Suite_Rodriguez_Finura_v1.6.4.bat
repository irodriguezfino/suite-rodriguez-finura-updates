...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.4_full.zip"
set "EXPECTED_SHA=82E2B52CF9BFC90051EFD73500C6EF8F3D66A1D5E36CBCE96DD156A770EBEC7D"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.4_full.zip"

echo Instalando %APP_NAME% 1.6.4
