...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.11_full.zip"
set "EXPECTED_SHA=AD7C71399A1E2EBD3778BCCF939019C5B2383FAED6935054A8DC256E1C1C5433"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.11_full.zip"

echo Instalando %APP_NAME% 1.7.11
