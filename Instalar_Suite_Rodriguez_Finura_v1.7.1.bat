...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.1_full.zip"
set "EXPECTED_SHA=ED3A50E435701E9ED5E543FD727F7B7CC47E6B6D3BAFDECD5E61C022609CFCBB"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.1_full.zip"

echo Instalando %APP_NAME% 1.7.1
