...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.6_full.zip"
set "EXPECTED_SHA=D5152997B5F022325328D428526E7C7AE29096296AA686B6C526F927366C97A8"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.6_full.zip"

echo Instalando %APP_NAME% 1.6.6
