...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.14_full.zip"
set "EXPECTED_SHA=1415D44B1FD00BDA7BDC843C8018ED83B5C1101125625DA7DED65A99EE5C41F3"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.14_full.zip"

echo Instalando %APP_NAME% 1.7.14
