...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.9_full.zip"
set "EXPECTED_SHA=A92DF6FA3FA3453EABE1519683282E413C93AA171C6C351378F2BCC0F70CEE32"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.9_full.zip"

echo Instalando %APP_NAME% 1.6.9
