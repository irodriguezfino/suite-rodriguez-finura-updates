...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.0_full.zip"
set "EXPECTED_SHA=F7F13753643F9354B6B6FEA7B82EB26C589B2E99DA046CDCC45163F3CE5CF2E9"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.0_full.zip"

echo Instalando %APP_NAME% 1.6.0
