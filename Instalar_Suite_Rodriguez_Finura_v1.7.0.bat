...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.0_full.zip"
set "EXPECTED_SHA=658F53BF8A9B4E764A0B72EE02C273E5E43990FFC46F63569FAD31D5AA8D1987"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.0_full.zip"

echo Instalando %APP_NAME% 1.7.0
