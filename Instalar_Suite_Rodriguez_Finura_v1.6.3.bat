...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.3_full.zip"
set "EXPECTED_SHA=131D2F7F121FA190461F79F03B5FA210740380EC4B6BAA54157179EB0319027D"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.3_full.zip"

echo Instalando %APP_NAME% 1.6.3
