...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.6.5_full.zip"
set "EXPECTED_SHA=06E520DCBECF0812CF152646CD122DC4B0B0AB01B8C578223B0F3BC45190CFE8"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.6.5_full.zip"

echo Instalando %APP_NAME% 1.6.5
