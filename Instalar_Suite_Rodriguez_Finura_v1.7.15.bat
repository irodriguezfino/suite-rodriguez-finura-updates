...
set "ZIP_FILE=%TEMP_ROOT%\Suite_Rodriguez_Finura_v1.7.15_full.zip"
set "EXPECTED_SHA=DDFC18F3212BF7A39325424DB481FFA96A990508AC5E4A558CE38035231B7D65"
set "DOWNLOAD_URL=https://raw.githubusercontent.com/irodriguezfino/suite-rodriguez-finura-updates/main/Suite_Rodriguez_Finura_v1.7.15_full.zip"

echo Instalando %APP_NAME% 1.7.15
